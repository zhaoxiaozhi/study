...
import static org.apache.rocketmq.remoting.protocol.LanguageCode.OMS;

public class SimpleProducer {

    public static void main(String[] args) {
        final MessagingAccessPoint messagingAccessPoint =
                io.openmessaging.OMS.getMessagingAccessPoint("oms:rocketmq://localhost:9876/default:default");
